...
module Jekyll
  ...
  class DataPage < Page
    ...
    def initialize(site, base, index_files, dir, data, name, template, extension) #, author, featimg, tags, category
      @site = site
      @base = base
      ...
      # site.data["post_name"] = data[name]
      # site.data["post_author"] = author
      # site.data["post_featimg"] = featimg
      # site.data["post_tags"] = tags
      # site.data["post_category"] = category
        ...
        data.each do |data_spec|
          ...
          if site.layouts.key? template
            ...
            data_spec['data'].split('.').each do |level|
              if records.nil?
                # puts "Site", site.data[level], level
                records = site.data[level]
                # puts "Out Records", records
              # else
              #   puts "Records", records[level], level
            ...
            records.each do |record|
              # print "Site FolderFlag: ", site.config['page_gen-dirs'], "\n"
              # print "FolderFlag: ", index_files, "\n"
              # print "Directory: ", dir, "\n"              
              # print "Name: ", name, "\n"
              ...
              # # print record["author"], "\n"
              # featimg = record["featimg"]
              # # print record["featimg"], "\n"
              # tags = record["tags"]
              # # print record["tags"], "\n"
              ...
              site.pages << DataPage.new(site, site.source, index_files, dir, record, name, template, extension) #, author, featimg, tags, category
            end
          else
